# https://contest.yandex.ru/contest/22450/run-report/144419795/
...
def read_input():
    ...
    data.property_indexes = property_indexes
    data.n = n


def get_property_distances():
    ...
    # n = data.n
    # property_indexes = data.property_indexes
...
read_input()
print(*get_property_distances())  # вывод распаковкой
