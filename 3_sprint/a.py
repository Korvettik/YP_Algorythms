# https://contest.yandex.ru/contest/23638/problems/A/#3484683/2020_05_05/cZe9CnUElE
...
def generate_bracket_sequences(n):
    ...
    def backtrack(curr, left, right):
        ...
        if left < n:
            #print(f'( {left} < {n}')
            backtrack(curr + '(', left + 1, right)  # тут же редактируем новый список и передаем его дальше рекурсивно,
            # т.е как-бы копируем и переносим с модификацией состояние из текущей локали в новую рекурсивную
