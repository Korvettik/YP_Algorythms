...
# Пространственная сложность определяем как О(1),
# т.к. в данном случае бинарный поиск не рекурсивно рабтает, а в цикле.
# И каждая итерация использует фиксированное количество переменных.
