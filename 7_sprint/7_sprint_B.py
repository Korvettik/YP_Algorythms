# https://contest.yandex.ru/contest/25597/run-report/154330562/
...
(Т.е. чтобы получить _5 и у нас есть .0, нам нужна '3 и такой индекс есть, это .3)
...
6.3)
От цели (ц5) до текущего значения очков (_1) получаем список индексов для просмотра --- ['5 '4 '3 '2 '1]
Смотрим значение в списке флагов по каждому из этих индексов ['5 - _1] = .4 там False, ничего не меняем
Смотрим значение в списке флагов по каждому из этих индексов ['4 - _1] = .3 и если там True,
то и флаг [.4] тоже будет True

 True  False  False  True   True   True
  .0    .1     .2    (.3)   (.4)    .5

Смотрим значение в списке флагов по каждому из этих индексов ['3 - _1] = .2 там False, ничего не меняем
Смотрим значение в списке флагов по каждому из этих индексов ['2 - _1] = .1 там False, ничего не меняем
Смотрим значение в списке флагов по каждому из этих индексов ['1 - _1] = .0 и если там True,
то и флаг [.1] тоже будет True
...
6.4)
От цели (ц5) до текущего значения очков (_1) получаем список индексов для просмотра --- ['5 '4 '3 '2 '1]
Смотрим значение в списке флагов по каждому из этих индексов ['5 - _1] = .4 уже True
Смотрим значение в списке флагов по каждому из этих индексов ['4 - _1] = .3 уже True
Смотрим значение в списке флагов по каждому из этих индексов ['3 - _1] = .2 там False, ничего не меняем
Смотрим значение в списке флагов по каждому из этих индексов ['2 - _1] = .1 и если там True,
то и флаг [.2] тоже будет True

 True   True   True  True   True   True
  .0    (.1)   (.2)   .3     .4     .5

Смотрим значение в списке флагов по каждому из этих индексов ['1 - _1] = .0 уже True


7)
В конце концов возвращаем значение флага под индексом размера половинки (.5)
...
Пространственная сложность - O(target)  Т.к. нам нужно хранить массив с флагами значений
