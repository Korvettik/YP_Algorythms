...
def is_mirror(root1, root2):
    ...
    return (root1.value == root2.value    # если значения корней равны
            and is_mirror(root1.left, root2.right)  # рекурсивно сравниваем левую голову левого ребенка и правую голову правого ребенка
            and is_mirror(root1.right, root2.left))  # рекурсивно сравниваем правую голову левого ребенка и левую голову правого ребенка
